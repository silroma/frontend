...
<head>
	...
	<style>
	.card {
	  box-shadow: 12px 15px 24px 0px #FF04004d;
	}
	...
	.card:hover {
	  box-shadow:12px 15px 26px 0px #FF04004d;
	}
	</style>
	<script>
...
<div class="wrapper">
	...
	<div class="card 2">
		<div class="card_image">
			<!--<img src="https://i.redd.it/b3esnz5ra34y.jpg" /> 
			<canvas id="myChart3" style="display: block; max-height: 90%;"></canvas>-->
		</div>
		<div class="card_title ">
			<p>Tenure</p>
		</div>
	...
	<div class="card 4">
		<div class="card_image">
			<!--<img src="https://i.redd.it/b3esnz5ra34y.jpg" /> 
			<canvas id="myChart" style="display: block; max-height: 90%;"></canvas>-->
		</div>
		<div  class="card_title">
			<p>Revenue</p>
		</div>
	...
	<div class="card 5">
		<div class="card_image">
			<!--<img src="https://i.redd.it/b3esnz5ra34y.jpg" /> 
			<canvas id="myChart2" style="display: block; max-height: 90%; height:90%;"></canvas>-->
		</div>
		<div class="card_title ">
			<p>Costs per department</p>
		</div>
	</div>
